...
import { generateComplaintSmart, generateEscalationSmart } from "../ai/geminiAdapters";
  ...
  compileComplaintPacket: async (issue: CivicIssue): Promise<CivicIssue> => {
    ...
    const updatedTimeline = [
      ...
      createTimelineEvent("complaint_generated", {
        description: `Formal representation compiled via Gemini (${result.meta.provider}). ready for submission.`,
      }),
    ];
