...
function seedCasesDb(): void {
  // Clear any existing
  casesDb = [];

  // Seed 1: Pothole on 12th Main Road
  casesDb.push({
    id: "CP-ROAD-72A8B",
  ...
  // Seed 2: Open Drain near Primary School
  casesDb.push({
    id: "CP-WATR-34B9C",
    title: "Critical Open Drain near School",
    category: "water_leakage",
    status: "overdue", // Breached 7-day SLA
    severity: "critical",
    harmScore: 88,
    locationName: "Indiranagar 100ft Road, opposite Government Primary School",
    latitude: 12.9716,
    longitude: 77.5946,
    reportedAt: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(), // 9 days ago
