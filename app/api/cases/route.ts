...
import { FirestoreCaseRepository } from "@/src/lib/repositories/firestoreCaseRepository";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const repository = new FirestoreCaseRepository();
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Defense-in-depth: Ensure any base64 media is written to disk rather than stored in Firestore
